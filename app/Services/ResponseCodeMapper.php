...
class ResponseCodeMapper
{
    private static $responseMap = [
        ...
        "54" => "Card expired or not yet effective",
        "55" => "Incorrect PIN",
        "56" => "No card record",
        ...
        "99" => "Issuer or switch inoperative"
    ];

    public static function handleResponse($code)
    {
        return self::$responseMap[$code] ?? "Unknown response code: $code";
    }
}
